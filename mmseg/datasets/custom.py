...
class CustomDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.img_infos = self.load_annotations(self.img_dir, self.img_suffix,
                                               self.ann_dir,
                                               self.seg_map_suffix, self.split_file)
    ...
    def get_gt_seg_maps(self, efficient_test=False):
        ...
        for img_info in self.img_infos:
            ...
            # print('segmap_path:', seg_map)

            if efficient_test:
                gt_seg_map = seg_map
            elif seg_map[:2] == "s3":
                file_client = mmcv.FileClient(**dict(backend='petrel'))
                img_bytes = file_client.get(seg_map)
